...
- 如何通过集成`DODOProxy`来使用外部合约与DODOV1 以及 DODOV2 池子进行买卖交互 [DODOProxyIntegrate.sol](https://github.com/DODOEX/dodo-example/blob/main/solidity/contracts/DODOProxyIntegrate.sol)

- 如何链外使用PMM算法来计算DODOV1 或者 DODOV2池子的买卖结果 [pmmOffchainCalc.ts](https://github.com/DODOEX/dodo-example/blob/main/solidity/scripts/pmmOffchainCalc.ts)
